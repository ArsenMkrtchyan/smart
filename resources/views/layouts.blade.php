...
<link rel="stylesheet" href="{{ asset('smart/assets/css/styles.min.css') }}">
    ...
    <link rel="stylesheet" href="{{asset('smart/assets/bootstrap/css/bootstrap.min.css')}}">

    <link rel="stylesheet" href="{{ asset('smart/assets/css/animate.min.min.css') }}">
    <link rel="stylesheet"  href="{{ asset('smart/assets/fonts/fontawesome-all.min.css') }}">
                    ...
                    <ul class="navbar-nav flex-nowrap ms-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="badge bg-danger badge-counter">7</span><i class="fas fa-envelope fa-fw"></i></a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                                    <h6 class="dropdown-header">alerts center</h6><a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image me-3"><img class="rounded-circle" href="{{ asset('smart/assets/img/avatars/avatar4.jpeg') }}">
                                        ...
                                        <div class="dropdown-list-image me-3"><img class="rounded-circle" href="{{ asset('smart/assets/img/avatars/avatar2.jpeg') }}">
                                        ...
                                        <div class="dropdown-list-image me-3"><img class="rounded-circle" href="{{ asset('smart/assets/img/avatars/avatar3.jpeg') }}">
                                        ...
                                        <div class="dropdown-list-image me-3"><img class="rounded-circle" href="{{ asset('smart/assets/img/avatars/avatar5.jpeg') }}">
                                            <div class="bg-success status-indicator"></div>
                                        </div>
                                        <div class="fw-bold">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" href="{{ asset('smart/assets/img/avatars/avatar1.jpeg') }}"></a>
...
<script href="{{ asset('smart/assets/bootstrap/js/bootstrap.min.js') }}"></script>
