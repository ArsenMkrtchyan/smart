                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('simlists.update' , $simlist->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="coin">Sim number:</label>
                                <input type="text" name="sim_number" class="form-control" value="{{$simlist->sim_number}}" required>
                            </div>
                            <div class="form-group">
                                <label for="coin">Sim Code:</label>
                                <input type="text" name="sim_code" class="form-control" value="{{$simlist->sim_code}}" required>
                            </div>
